            ...
            <div class="about-info-text">
                ...
                <div class="about-info-text-years">
                    ...
                    <div class="about-info-text-year"><b>С&nbsp;2019&nbsp;года&nbsp;—</b> участник
                        Медико-технологического кластера Московской области
                    </div>
                </div>
            </div>
        </div>
...
<section class="oversection welcome-news">
    <div class="container">
        ...
        <div class="news-grid">
            <?php
            $news = [
                ['link' => '#', 'image' => '/assets/img/news/1.png', 'date' => '7 мая', 'title' => '«Уральская ватная компания» примет участие в Региональном конгрессе медицинских сестёр в Тюмени', 'description' => 'Тюмень, 2026 год. В преддверии Международного дня медицинской сестры состоится масштабное...'],
                ['link' => '#', 'image' => '/assets/img/news/2.png', 'date' => '7 мая', 'title' => 'Масштабирование производства современных перевязочных средств EVERSMED как результат признания на рынке', 'description' => 'Группа компаний Эверс груп Рус в 2026 году нарастила объёмы производства современных перевязочных средств...'],
                ['link' => '#', 'image' => '/assets/img/news/3.png', 'date' => '6 мая', 'title' => 'Укусы насекомых: как быстро снять зуд и предотвратить воспаление', 'description' => 'Лето — пора пикников, прогулок на природе и активного отдыха. Но вместе с приятными впечатлениями могут прийти...'],
            ];
            ?>
    ...
    <div class="container">
        <div class="welcome-contacts-wrapper">
            <div class="welcome-contacts-left">
                ...
                <a href="/coop/request" class="btn btn-white btn-full">Оставить заявку на сотрудничество</a>
            </div>
